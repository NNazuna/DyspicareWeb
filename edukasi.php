                ...
                <div class="row gx-5 d-flex justify-content-center align-items-center">
                    <div class="col d-flex justify-content-center align-items-center">
                        <div>
                            ...
                            dan mual dan kadang-kadang dapat disertai dengan muntah, meskipun hal ini jarang terjadi. jika gejala-gejala tersebut kamu alami, segera hubungi dokter untuk mendapat penanganan lebih lanjut.  </p>
                        </div>
                    </div>
                    <div class="col">
                ...
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 my-5">
                    ...
                    <div class="col">
                        <div class="d-flex flex-column align-items-center border-card p-3">
                            ...
                            <div class="card-body">
                                <a href="edukasi.php"> Consultation </a>
